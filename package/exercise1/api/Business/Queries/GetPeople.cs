...
namespace StargateAPI.Business.Queries
{
    ...
    public class GetPeopleHandler : IRequestHandler<GetPeople, GetPeopleResult>
    {
        ...
        public async Task<GetPeopleResult> Handle(GetPeople request, CancellationToken cancellationToken)
        {
            ...
            var query = $"SELECT a.Id as PersonId, WHERE a.FirstName = @FirstName AND a.LastName = @LastName, b.CurrentRank, b.CurrentDutyTitle, b.CareerStartDate, b.CareerEndDate FROM [Person] a LEFT JOIN [AstronautDetail] b on b.PersonId = a.Id";
